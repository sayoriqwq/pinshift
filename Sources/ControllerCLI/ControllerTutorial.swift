public enum ControllerTutorial {
  public static let output = """
    ...
    8. Run `rl-install` once to build and authorize the stable signed controller and persistent Cleanup Guardian, then use `rl-start` for daily sessions.
