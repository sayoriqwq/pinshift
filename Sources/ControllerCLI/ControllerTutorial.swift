public enum ControllerTutorial {
  public static let output = """
    ...
    8. Run `pinshift setup` once to build and authorize the controller. Run `pinshift` when testing, keep that terminal open, and press Ctrl-C to perform a real Clear before exit.
